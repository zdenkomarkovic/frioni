        ...
        <div className="grid lg:grid-cols-2 gap-12 xl:gap-20">
          <div>
            ...
            <p className="text-gray-400 text-base leading-relaxed mb-8">
              Popunite formu i kontaktiraćemo vas u najkraćem roku. Odgovaramo isti dan, obično za
              par sati.
            </p>
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="flex items-start gap-3 cursor-pointer">
                    ...
                    <span className="text-gray-400 text-xs leading-relaxed">
                      Slanjem ovog obrasca saglasan/na sam da FRIONI servis koristi moje kontakt
                      podatke isključivo u svrhu odgovora na zahtev za servis.
                    </span>
                  </label>
          ...
          <div className="flex flex-col gap-8">
            <div className="relative h-56 sm:h-72 rounded-2xl overflow-hidden">
              <Image src="/12027.png" alt="FRIONI tim" fill className="object-cover" />
            </div>

            <div className="bg-[#0c1220] border border-white/8 rounded-2xl p-7 space-y-5">
              <h3 className="text-white font-bold text-lg">Kontakt informacije</h3>
              ...
              <a href={CONTACT_VIBER_HREF} className="flex items-center gap-3 group">
                <div className="w-10 h-10 rounded-lg bg-purple-500/15 flex items-center justify-center flex-shrink-0 group-hover:bg-purple-500/25 transition-colors">
                  <FaViber className="w-5 h-5 text-purple-400" size={20} />
                </div>
                <div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-white font-semibold text-sm">{CONTACT_ADDRESS}</p>
                </div>
              </div>
            </div>
          </div>
